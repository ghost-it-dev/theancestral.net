    ...
    <>
      <div className="relative flex min-h-[100vh] flex-col">
        ...
        <div className="mx-auto w-full max-w-7xl flex-grow lg:flex xl:px-8">
          ...
          <main className={classNames(postActivity.length !== 0 ? 'min-w-0 flex-1 bg-[#101826] xl:flex lg:border-l lg:border-[#1F2C37]' : 'min-w-0 flex-1 bg-[#101826] xl:flex lg:border-x lg:border-[#1F2C37]')}>{children}</main>
          {/* Activity feed */}
