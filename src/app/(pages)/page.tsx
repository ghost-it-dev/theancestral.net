                    ...
                    <div className='hidden flex-shrink-0 flex-col items-end space-y-2 sm:flex'>
                      <div className='flex flex-row gap-1'>
                        {['Windows', 'Linux', 'MacOS'].map((os) => (
                          <span key={os} className='flex items-center px-1.5 py-0.5 rounded-[4px] text-xs font-bold bg-[#1E2936] text-gray-300 group-hover:bg-[#101826] transition-colors'>
                            {os}
                          </span>
                        ))}
                      </div>
